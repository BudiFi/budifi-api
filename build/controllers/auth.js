...
var loginUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var email, errors, err, result, err;
    return __generator(this, function (_a) {
        ...
        try {
            result = users_1.default.findOne({ email: email });
            if (!result) {
                res.status(404).json({
...
var signupUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, first_name, last_name, errors, err, findUserByEmail, hashedPassword, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, new users_1.default({
